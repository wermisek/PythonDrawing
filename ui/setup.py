...
class SetupWindow:
    def __init__(self, parent, bot, tools, on_complete, title='Child Window', w=700, h=600, x=5, y=5):
        ...
        # Configure dark theme for this window
        style = Style(self._root)
        style.configure('Setup.TFrame', background='#2b2b2b')
        style.configure('Setup.TLabelframe', background='#2b2b2b', foreground='#ffffff')
        style.configure('Setup.TLabelframe.Label', background='#2b2b2b', foreground='#ffffff')
        style.configure('Setup.TLabel', background='#2b2b2b', foreground='#ffffff')
        style.configure('Setup.TButton', background='#404040', foreground='#ffffff')
        style.configure('Setup.TEntry', fieldbackground='#404040', foreground='#ffffff')
